...
#define DO   4
#define CS0  5 //thermocouple0
#define CS1  8 //thermocouple1
#define CLK  6
Adafruit_MAX31855 thermocouple0(CLK, CS0, DO);
...
void loop() {
  ...
  int lmod = l*stm/t;  //portion of total loops calculated from stm
